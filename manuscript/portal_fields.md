...
> The authors used Claude Code v2.1.239 (Anthropic) and Codex CLI v0.149.0 (OpenAI) for
> language editing and for the analysis, figure-rendering, and typesetting code. No claim,
