The estimator is the locked SPGD stack \cite{Fu2026spgd} plus two operators: a KEEP/ABSTAIN reportability gate and a patient-identity donor split (Fig.~\ref{fig:protocol}A--F). Related mixed-spot readers recover composition, including RCTD, cell2location, DestVI, and CARD~\cite{Cable2022,Kleshchevnikov2022,Lopez2022,Ma2022}. This protocol adds an explicit rule for when the malignant coordinate is reportable.
